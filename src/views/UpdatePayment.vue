  ...
  <main>
    ...
    <div class="my-5">
      <div class="mx-auto w-25" style="max-width: 100%">
        <h2 class="text-center mb-3">Update Payment</h2>
        <form @submit.prevent="updatePayments">
          ...
          <div class="row">
            <div class="col-md-12 form-group mb-3">
              <label for="amount" class="form-label">Сума (у грн)</label>
...
export default {
  ...
  methods: {
    getPayments() {
      fetch(`http://localhost:8080/payments/${this.$route.params.id}`)
          .then(res => res.json())
          .then(data => {
            this.payment = data;
    ...
    updatePayments() {
      if (!this.isFormInvalid) {
        fetch('http://localhost:8080/payments/' + this.payment.id, {
          method: 'PATCH',
          headers: {
